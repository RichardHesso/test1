...
const headCellsRef2Deposits = [
  { id: 'amount', label: 'Сумма', orderBy: 'amount', disabled: false },
  { id: 'created_at', label: 'Создано', orderBy: 'created_at', disabled: false },
]

const headCellsRef2Withdraws = [
  { id: 'amount', label: 'Сумма', orderBy: 'amount', disabled: false },
...
const headCellsRef2ReferalWithdraws = [
  { id: 'amount', label: 'Сумма', orderBy: 'amount', disabled: false },
  { id: 'created_at', label: 'Создано', orderBy: 'created_at', disabled: false },
  //{ id: 'status', label: 'Статус', orderBy: 'status', choiceMap: getStatusLabel, disabled: false },
]

const headCellsRef2Users = [
...
const RefProgram2View = () => {
  ...
  const getRefInfo = useCallback(async () => {
    try {
      ...
      const response = await axios.get(`/api/users/ref2_user_info/`);
          ...
          <Grid container spacing={3}>
            ...
            <Grid item xs={12}>
              ...
              <MyTable 
                ...
                headCells={headCellsRef2Adds}
                extraQuery={'ref_system=ref2'}
              />
            </Grid>
            <Grid item xs={12}>
              <h3>Выводы</h3>
              <MyTable 
                ...
                headCells={headCellsRef2Withdraws}
                extraQuery={'withdraw_type=ref2'}
              />
            </Grid>
          </Grid>
          ...
          <Grid container spacing={3}>
            ...
            <Grid item xs={12}>
              ...
              <MyTable 
                ...
                headCells={headCellsRef2Deposits}
                extraQuery={'user__ref_system=ref2'}
              />
            </Grid>
            <Grid item xs={12}>
              <h3>Выводы рефералов</h3>
              <MyTable 
                urlPath={'/api/finance/referal_withdraws/'}
                headCells={headCellsRef2ReferalWithdraws}
                extraQuery={'withdraw_type=balance'}
              />
            </Grid>
          </Grid>
...
export default RefProgram2View;
