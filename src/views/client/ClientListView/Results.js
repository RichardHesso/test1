...
const headCells = [
  ...
  { id: 'total_deposits', label: 'TotalDeposits', orderBy: '', disabled: true },
  { id: 'total_withdraws', label: 'TotalWithdraws', orderBy: '', disabled: true },
  { id: 'count_deposits', label: 'CountDeposits', orderBy: '', disabled: true },
];
