...
const editFields = [
    ...
    { id: 'name', label: 'Название', type: 'text', variant: 'outlined', disabled: false, style: {marginTop: 10}, defaultValue: '' },
    { id: 'order_bot_text', label: 'Текст заявки в  боте', type: 'multiline', variant: 'outlined', disabled: false, style: {marginTop: 10}, defaultValue: '' },
    { id: 'confirm_payment_bot_text', label: 'Текст после подтреждния оплаты', type: 'multiline', variant: 'outlined', disabled: false, style: {marginTop: 10}, defaultValue: '' },
    { id: 'is_active', label: 'Активно', type: 'checkbox', variant: 'outlined', disabled: false, style: {marginTop: 10}, defaultValue: false },
    { id: 'is_active_withdraw', label: 'Активно для вывода', type: 'checkbox', variant: 'outlined', disabled: false, style: {marginTop: 10}, defaultValue: false },
    { id: 'withdraw_pmethod_text', label: 'Текст в боте где вывод', type: 'multiline', variant: 'outlined', disabled: false, style: {marginTop: 10}, defaultValue: '' },
    { id: 'wallet_req_exp', label: 'Reg exp для проверки кошелька', type: 'text', variant: 'outlined', disabled: false, style: {marginTop: 10}, defaultValue: '' },
    { id: 'wallet_error_text', label: 'Текст в боте если кошелек неправильный', type: 'multiline', variant: 'outlined', disabled: false, style: {marginTop: 10}, defaultValue: '' },
  ];
        ...
        try {
          ...
          if (itemId) {
            response = await axios.patch(`/api/finance/pmethods/${itemId}/`, {
              ...
              is_active_withdraw: values.is_active_withdraw,
              withdraw_pmethod_text: values.withdraw_pmethod_text,
              wallet_req_exp: values.wallet_req_exp,
              wallet_error_text: values.wallet_error_text
            });
